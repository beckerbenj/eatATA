...
av_time <- minimaxConstraint(nForms, itemValues = items$time, targetValue = 10,
                             itemIDs = items$item)
```
...
mc_openItems <- autoItemValuesMinMax(nForms = nForms, itemValues = items$MC_open_none, 
                                     itemIDs = items$item)
cmcItems <- autoItemValuesMinMax(nForms = nForms, itemValues = items$f_CMC, itemIDs = items$item)
