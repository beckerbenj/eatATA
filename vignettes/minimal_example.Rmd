...
testInfo <- maxConstraint(nForms = 1, itemValues = items_mini$IIF,
                          itemIDs = items_mini$id)
```
...
testTime <- itemValuesDeviation(nForms = 1, 
                                itemValues = items_mini$mean_time,
                                targetValue = 8 * 60, 
                                allowedDeviation = 5,
                                relative = FALSE, 
                                itemIDs = items_mini$id)
...
inspectSolution(solver_out, items = items_mini, idCol = "id")
```

```{r append, message = FALSE}
appendSolution(solver_out, items = items_mini, idCol = "id")
```
