...
Next, we clean the imported data: All dummy variables have to use the values 0 (category does not apply) and 1 (category does apply). Alternatively, item properties can also be supplied as factors (see `?autoItemValuesMinMax` for further information).
