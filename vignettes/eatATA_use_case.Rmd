...
itemOverlap <- itemUsageConstraint(nForms, nItems = nItems, operator = "=", itemIDs = items$Item_ID) 
```
...
noItems <- itemsPerFormConstraint(nForms = nForms, nItems = nItems, 
                                  operator = ">=", min_Nitems, itemIDs = items$Item_ID)
...
av_time <- minimaxConstraint(nForms, nItems = nItems, itemValues = items$RT_in_min, targetValue = 10,
                             itemIDs = items$Item_ID)
```
